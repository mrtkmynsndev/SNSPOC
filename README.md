...
```
{
 ...
 ```
**Kullanım Önerisi:** publish ve subscribe için "Everyone" olarak seçilmesi önerilmiyor. Publish için "Only the specified AWS account", Subscribe için ise "Only request with certain endpoints" seçimleri öneriliyor.
